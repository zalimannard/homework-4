...
[Гиляутдинов. Транспортная задача. Решение методом потенциалов](http://galyautdinov.ru/post/transportnaya-zadacha) - 50/50 написано

[Хабр. Транспортная задача линейного программирования](https://habr.com/ru/post/573224/) - Много буковок, но по делу

[YouTube разбор. Транспортная задача (закрытая, с циклом)](https://www.youtube.com/watch?v=1jBa_2IYDNY) - Самое понятное объяснение решение
